...
static SLang_Intrin_Fun_Type Module_Intrinsics [] =
{
  ...
  MAKE_INTRINSIC_0("cuda", slcuda_init_array, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudaarr", slcuda_init_dev_array, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudafree", slcuda_free_intrin, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudaget", slcuda_fetch_array, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudaadd", slcuda_add, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudasub", slcuda_sub, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudamul", slcuda_mul, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudadiv", slcuda_div, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudapow", slcuda_pow, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudaacc", slcuda_acc, SLANG_VOID_TYPE),
  MAKE_INTRINSIC_0("cudasmooth", slcuda_smooth, SLANG_VOID_TYPE),
